...
public class Client {
    ...
    private MessageType lastMessage = MessageType.FREE;
            ...
            while (sock.isConnected()) {
                try {
                    ...
                    if (msg.getType() == MessageType.DATA || msg.getType() == MessageType.DATA_SHORT) {
                        ...
                        if (msg.getType().equals(MessageType.DATA_SHORT)){
                            boolean xit = false;
                            while (!xit) {
                                ...
                                if (probability < 40) {
                                    ...
                                    Thread.sleep(probability*10);
                                }
                            }
                        } else {
                            while (!lastMessage.equals(MessageType.FREE)) {
